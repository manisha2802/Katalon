...
WebUI.click(findTestObject('Object Repository/MakeAppointment/Page_CURA Healthcare Service/a_Make Appointment'))
...
WebUI.click(findTestObject('Object Repository/MakeAppointment/Page_CURA Healthcare Service/input_Medicaid_programs'))

WebUI.click(findTestObject('Object Repository/MakeAppointment/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))
...
WebUI.click(findTestObject('Object Repository/MakeAppointment/Page_CURA Healthcare Service/i_CURA Healthcare_fa fa-bars'))

WebUI.click(findTestObject('Object Repository/MakeAppointment/Page_CURA Healthcare Service/a_Logout'))
